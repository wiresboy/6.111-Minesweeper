...
[picture] = imread('./Images/facing_down.bmp');
...
[picture, color_table] = imread('./Images/facingDown.bmp');
...
%open a file
output_name = './Images/facing_down_color.coe';
...
%open a file
output_name = './Images/facing_down.coe';
file = fopen(output_name,'w');
