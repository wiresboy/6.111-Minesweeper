...
#
# Generated by export_simulation on Tue Nov 19 20:06:07 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './flag_image_rom.sh' script.

./flag_image_rom.sh -reset_run
...
./flag_image_rom.sh -noclean_files

For more information on the script, please type './flag_image_rom.sh -help'.
