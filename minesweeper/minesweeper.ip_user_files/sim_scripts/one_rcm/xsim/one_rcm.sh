...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot one_rcm xil_defaultlib.one_rcm xil_defaultlib.glbl -log elaborate.log
}
