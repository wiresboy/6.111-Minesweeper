...
#
# Generated by export_simulation on Tue Nov 19 18:39:17 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './zero_bcm.sh' script.

./zero_bcm.sh -reset_run
...
./zero_bcm.sh -noclean_files

For more information on the script, please type './zero_bcm.sh -help'.
