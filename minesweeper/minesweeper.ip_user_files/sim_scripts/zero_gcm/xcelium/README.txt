...
#
# Generated by export_simulation on Mon Nov 18 23:59:06 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './zero_gcm.sh' script.

./zero_gcm.sh -reset_run
...
./zero_gcm.sh -noclean_files

For more information on the script, please type './zero_gcm.sh -help'.
