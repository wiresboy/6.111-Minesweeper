...
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33    PULLTYPE PULLUP } [get_ports { ps2_clk }]; #IO_L13P_T2_MRCC_35 Sch=ps2_clk
set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33    PULLTYPE PULLUP } [get_ports { ps2_data }]; #IO_L10N_T1_AD15N_35 Sch=ps2_data
